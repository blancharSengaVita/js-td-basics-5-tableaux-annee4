...
// console.log(`le premier jour de la semaine est ${jour[0]}`);
// console.log(`le dernier jour de la semaine est ${jour[6]}`);
...
// console.log(jour.length);
// console.log(jour[jour.length-1]);
...
// jour[5] = "saturday";
// console.table(jour);
// const jourFerie = jour[6];
// console.log(jourFerie);
// jour[jour.length] = "dimanche2";
// console.table(jour);

// // 5. Un tableau peut contenir des données de différents types
var john = ['John', 'Smith', 1990, 'designeer', false];
// 	Un tableau peut même contenir un tableau
var mark = ['Mark', 'Smith', 1990, 'designeer', ['John', 'Mary'], true];
//
//
...
const fruits = ["pomme", "banane", "poire", "pêche", "orange",];
fruits.unshift("fraise");
fruits.push("myrtille");
console.table(fruits);

console.log(`la poire est mon fruit est ${fruits.indexOf("poire")} il porte l'indice ${fruits.indexOf("poire")-1}`);

fruits.reverse()

console.table(`mon tableau est inversé ${fruits}`);

const isMangue = fruits.indexOf("mangue") !== -1 ? "mangue est dans le tableau" : "mangue n'est pas dans le tableau";
